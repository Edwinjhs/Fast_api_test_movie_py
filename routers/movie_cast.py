...
@movie_cast_router.get('/movie/{id_movie}/cast/', tags=['MOVIE-CAST'],response_model=list[MovieCast],status_code=200)
...
@movie_cast_router.post('/cast', tags=['MOVIE-CAST'],response_model=dict,status_code=201)
